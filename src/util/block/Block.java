...
public enum Block {
    ...
    ICE, DIORITE, ANDESITE, MARBLE, COBBLESTONE, MOSSY_COBBLESTONE, GRANITE, SANDSTONE, LIMESTONE, BASALT, PUMICE, CALCITE, QUARTZITE, SLATE, BIOTITE, TUFF, OBSIDIAN, // minerals/rocks
